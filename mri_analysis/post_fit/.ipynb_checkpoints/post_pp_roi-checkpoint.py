...
roi_masks = cortex.utils.get_roi_masks(subject = subject, xfmname = xfm_name, roi_list = 'V1', return_dict=True)
#index_volume, index_labels = cortex.utils.get_roi_masks(subject = subject, xfmname = xfm_name, roi_list = rois, gm_sampler = 'cortical-conservative',return_dict=False):

...
behav_txt_head{6}       =   'seq_acquisition';              behav_mat_res{6}        = 	expDes.expMat(:,4);
...
behav_txt_head{10}      =   'stim_noise_ori';               behav_mat_res{10}       = 	expDes.expMat(:,8);
behav_txt_head{11}      =   'stim_stair_val';               behav_mat_res{11}       = 	expDes.expMat(:,11);
behav_txt_head{12}      =   'response_val';                 behav_mat_res{12}       = 	expDes.expMat(:,12);
behav_txt_head{13}      =   'probe_time';                   behav_mat_res{13}       = 	expDes.expMat(:,13);
behav_txt_head{14}      =   'reaction_time';                behav_mat_res{14}       = 	expDes.expMat(:,14)-expDes.expMat(:,13);

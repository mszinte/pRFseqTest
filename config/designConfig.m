...
% Cond 2 : Sequence acquisition (2 modalities)
% =======
expDes.twoC             =   [1;2];
expDes.txt_cond2        =   {'sequence1','sequence2'};
% 01 = sequence 1
% 02 = sequence 2
...
for t_bar_pass = 1:size(const.bar_dir_run,2)
    ...
    for bar_step = 1:bar_pos_per_pass
        ...
        expDes.expMat(t_trial,:)=   [   runT,           t_trial,        cond1,          cond2,          rand_var1,  ...
                                        t_bar_pass,     bar_step,       rand_rand1,     NaN,            NaN,        ...
                                        NaN,            NaN,            NaN,            NaN];
        % col 01:   Run number
        % col 02:   Trial number
        % col 03:   Attention task
        % col 04:   Sequence acquisition
        % col 05:   Bar direction
        % col 06:   Bar pass period
        % col 07:   Bar step
        % col 08:   Stimulus noise orientation
        % col 09:   Trial onset time
        % col 10:   Trial offset time
        % col 11:   Stimulus noise staircase value
        % col 12:   Reponse value (correct/incorrect)
        % col 13:   Probe time
        % col 14:   Response time
    end
end
